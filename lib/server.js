  ...
  function queryPaths(req, res, next){
    ...
    Promise.all(TopLevelPromiseArr)
      ...
      switch (RequestCase) {
        ...
        case 3:
          // AuId Id
          // TODO: Promise Request AA.AuId1 ==> Id3 ==> Id4 ==> Id2
          // One Hop
          if (e2[0].AA) {
      ...
      Promise.all(secArr).then(function () {
            ...
            case 2:
              ...
              e1[0].RId.forEach(function(id3) {
                ...
                id3En.RId.forEach(function(id4) {
                  ...
                  for (var e2enIdx = 0; e2enIdx < e2.entities.length; e2enIdx++) {
                    if (e2.entities[e2enIdx].Id in id4En.RId) {
                      threeHop.push([id1, id3, id4, id2]);
                    }
                  }
                });
              });
        ...
        Promise.all(thirdArr).then(function () {
          ...
          console.log(oneHop.concat(twoHop, threeHop).length);
        });
