      ...
      Promise.all(secArr).then(function () {
        ...
        if (secArr.length != 0) {
          ...
          if (e2.C) {
            ...
            // Id1 <== Id3 <== C.Cid <== Id2
            responses[e2.C.CId.toString()].entities.find(function(ele) {
              if (id1 in ele.RId) {
                threeHop.push([id1, ele.Id, e2.C.CId, id2]);
              }
            });
          }
          ...
          if (e2.J) {
            ...
            // Id1 <== Id3 <== J.Jid <== Id2
            responses[e2.J.JId.toString()].entities.find(function(ele) {
              if (id1 in ele.RId) {
                threeHop.push([id1, ele.Id, e2.J.JId, id2]);
              }
            });
          }
          ...
          if (e1.F) {
            ...
            // Id1 ==> F.Fid ==> Id3 ==> Id2
            for (var fIdx = 0; fIdx < e1.J.length; fIdx++) {
          ...
          if (e2.F) {
            ...
            // Id1 <== Id3 <== F.Fid <== Id2
            for (var fIdx = 0; fIdx < e2.J.length; fIdx++) {
              responses[e2.F[fIdx].FId.toString()].entities.find(function(ele) {
                if (id1 in ele.RId) {
                  threeHop.push([id1, ele.Id, e2.F[fIdx].FId, id2]);
                }
              });
            }
          }
          ...
          if (e2.AA) {
            ...
            // Id1 <== Id3 <== AA.AuId <== Id2
            e2.AA.find(function(ele) {
              responses[ele.AuId.toString()].entities.find(function (aaEn) {
                if (id1 in aaEn.RId) {
                  threeHop.push([id1, aaEn.Id, ele.AuId, id2]);
                }
              });
            });
          }
